...
# idea
'''
1. arr1, arr2를 받아서 각각 숫자에 해당하는 이진수를 얻음 (10진수 -> 2진수)
2. 이진수의 값에 따라 arr1, arr2의 같은 위치의 두 원소가 다 공백인 경우에만 2차원리스트를 0으로
3. 마지막에 0, 1로 만들어지는 이차원리스트 완성하면 거기서 취합한 결과 출력
데이터를 용이하게 다루기 위하여 모두 리스트 형태로 조작
'''
